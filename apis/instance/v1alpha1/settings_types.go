...
type SettingsParameters struct {
	...
	// Settings is the map of settings to be applied. The key is the unique identifier of the setting and the value is the value of the setting. The format of the value depends on the type of the setting. It can be a string, a number, a boolean or a JSON object.
...
// A Settings is an example API type.
